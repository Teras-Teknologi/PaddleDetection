...
class SDE_Detector(Detector):
    ...
    def __init__(
        ...
        # tracker config
        self.use_deepsort_tracker = (
            True if tracker_cfg["type"] == "DeepSORTTracker" else False
        )
    ...
    def predict_image(
        self, image_list, run_benchmark=False, repeats=1, visual=True, seq_name=None
    ):
        num_classes = self.num_classes
        image_list.sort()
        ...
        for frame_id, img_file in enumerate(image_list):
            ...
            if visual:
                ...
                cv2.imwrite(os.path.join(save_dir, "{:05d}.jpg".format(frame_id)), im)
